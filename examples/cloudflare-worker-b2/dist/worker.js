...
const extractCreationHeaders = (ctx) => {
    ...
    const header = (key) => ctx.request.headers[key];
...
class Tussle {
    ...
    chooseProtocolVersion(ctx) {
        const clientVersion = ctx.request.headers['tus-resumable'];
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.TussleRequestCloudflareFetch = void 0;
...
class TussleRequestCloudflareFetch {
    makeRequest(request) {
        var _a;
        let request$;
...
exports.TussleRequestCloudflareFetch = TussleRequestCloudflareFetch;
});
...
Object.defineProperty(exports, "TussleRequestCloudflareFetch", { enumerable: true, get: function () { return request.TussleRequestCloudflareFetch; } });
});
...
class TussleCloudflareMiddleware {
    constructor(options) {
        this.middleware = () => (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            const req = yield prepareRequest(this.core);
            console.log(req);
...
var lib$4 = middleware.TussleCloudflareMiddleware;

...
const base64_js_1 = __importDefault(base64Js);

const fragment = '/b2_authorize_account';
function b2AuthorizeAccountRequest(url, options) {
    const authorization = 'Basic ' + base64_js_1.default.fromByteArray(Buffer.from([
        options.applicationKeyId,
        options.applicationKey,
    ].join(':')));
    return rxHttpRequest.RxHR.get(url + fragment, {
        json: true,
        headers: {
            authorization,
        },
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2CancelLargeFileRequest = void 0;

const fragment = '/b2_get_upload_url';
function b2CancelLargeFileRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
            authorization,
        },
...
exports.b2CancelLargeFileRequest = b2CancelLargeFileRequest;
});

var b2FinishLargeFile = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2FinishLargeFileRequest = void 0;

const fragment = '/b2_finish_large_file';
function b2FinishLargeFileRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2FinishLargeFileRequest = b2FinishLargeFileRequest;
});

var b2GetFileInfo = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2GetFileInfoRequest = void 0;

const fragment = '/b2_get_file_info';
function b2GetFileInfoRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2GetFileInfoRequest = b2GetFileInfoRequest;
});

var b2GetUploadPartURL = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2GetUploadPartURLRequest = void 0;

const fragment = '/b2_get_upload_part_url';
function b2GetUploadPartURLRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2GetUploadPartURLRequest = b2GetUploadPartURLRequest;
});

var b2GetUploadURL = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2GetUploadURLRequest = void 0;

const fragment = '/b2_get_upload_url';
function b2GetUploadURLRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2GetUploadURLRequest = b2GetUploadURLRequest;
});

var b2ListFileNames = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2ListFileNamesRequest = void 0;

const fragment = '/b2_list_file_names';
function b2ListFileNamesRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2ListFileNamesRequest = b2ListFileNamesRequest;
});

var b2ListParts = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2ListPartsRequest = void 0;

const fragment = '/b2_list_parts';
function b2ListPartsRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2ListPartsRequest = b2ListPartsRequest;
});

var b2ListBuckets = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2ListBucketsRequest = void 0;

const fragment = '/b2_list_buckets';
function b2ListBucketsRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2ListBucketsRequest = b2ListBucketsRequest;
});

var b2ListUnfinishedLargeFiles = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2ListUnfinishedLargeFilesRequest = void 0;

const fragment = '/b2_list_unfinished_large_files';
function b2ListUnfinishedLargeFilesRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2ListUnfinishedLargeFilesRequest = b2ListUnfinishedLargeFilesRequest;
});

var b2StartLargeFile = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
exports.b2StartLargeFileRequest = void 0;

const fragment = '/b2_start_large_file';
function b2StartLargeFileRequest(cfg, options) {
    const { authorization, url } = cfg;
    return rxHttpRequest.RxHR.post(url + fragment, {
        json: true,
        headers: {
...
exports.b2StartLargeFileRequest = b2StartLargeFileRequest;
});
...
class B2 {
    constructor(options) {
        this.reauthorize$ = new _esm5.Subject();
        ...
        // Authorization
        this.authorizationResponse$ = this.reauthorize$.pipe(operators.startWith(undefined), // Perform an initial request without reauthorize$.next()
        operators.switchMap(() => actions$1.b2AuthorizeAccountRequest(exports.B2_API_URL, {
            applicationKey: this.options.applicationKey,
            applicationKeyId: this.options.applicationKeyId,
        })), operators.shareReplay({ refCount: false, bufferSize: 1 }));
        this.authorization$ = this.authorizationResponse$.pipe(operators.map((response) => response.body));
    }
...
exports.B2 = B2;
const bindAction = (b2, actionFunc) => {
    return (options) => b2.authorization$.pipe(operators.switchMap(({ authorizationToken, apiUrl }) => {
        const config = {
            url: apiUrl + '/b2api/v2',
